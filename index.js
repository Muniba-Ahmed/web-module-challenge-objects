...
const pizza = createMenuItem("Cheese Pizza", 10, "Dinner");
const biryani = createMenuItem("Biryani", 20, "Dinner");
const icecream = createMenuItem("Chocolate Icecream", 5, "Dessert");
...
*/
console.log(reviews[4].name);

//not graded in tests,still do
...
*/
//end of guided project 'dogeyecolor
reviews[7].feedback =
...
function addReview(array, reviewName, reviewRating, reviewFeedback) {
  array.push({
    name: "Daniela",
    rating: 5,
    review: "Beautiful atmosphere and wonderful vegan options!",
  });
  return array;
}
//array.push({})
...
Use the getReviewByIndex function below to do the following:
  1. Receive an array, array is a param, number is a param-desired index,
